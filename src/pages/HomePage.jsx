      ...
      <div className='bg-white'>
        ...
        <div className='md:px-10 p-5 gap-10'>
          <div className='grid md:grid-cols-2 grid-cols-1 gap-10'>
            {/* student card */}
            <div className='md:mt-0 mt-2 bg-linear-to-br from-red-200 to-blue-400 rounded-lg shadow hover:shadow-lg hover:shadow-blue-700 hover:scale-102 transition'>
              {/* outer */}
              <div className=''>
                ...
                <div className='flex justify-end md:me-20 gap-5 mb-15 mt-5'>
                  <button className='bg-yellow-300 font-semibold px-4 py-1 text-white rounded hover:bg-yellow-500 transition cursor-pointer shadow'>Edit</button>
                  <button className='bg-red-500 font-semibold px-4 py-1 text-white rounded hover:bg-red-700 transition cursor-pointer shadow'>Delete</button>
                </div>
