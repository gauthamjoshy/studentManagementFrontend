...
function LandingPage() {
  ...
  return (
    <>
      ...
      <div className=' grid lg:grid-cols-2 sm:grid-cols-1 sm:pe-24 sm:p-24 bg-gray-200'>
        <div id='motiondiv1' className='flex justify-center items-center'>
          <div className=''>
            <h1 className='text-5xl font-extrabold '>Welcome to <span className='text-blue-900 text-6xl mask-t-from-neutral-950'>StudentManager</span></h1>
            ...
            <div className='flex lg:justify-start sm:justify-center sm:items-center'>
        ...
        <div id='motiondiv2' className='flex justify-center items-center sm:mt-10'>
